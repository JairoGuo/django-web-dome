...
from sonsuz.quora import views

app_name = "quora"
urlpatterns = [
    path("", views.QuestionListView.as_view(), name="all-questions"),
    path('correct-answered-questions', views.CorrectAnsweredQuestionListView.as_view(),
         name='correct-answered-questions'),
    ...
    path('create-answer/<int:question_id>/<str:question_slug>/', views.AnswerCreateView.as_view(),
         name='create_answer'),
