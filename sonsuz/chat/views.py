...
from sonsuz.utils.utils import ajax_required
...
class MessagesListView(LoginRequiredMixin, ListView):
    ...
    def get_context_data(self, *, object_list=None, **kwargs):
        ...
        # 最近一次私信互动的用户
        last_conversation = Message.objects.get_most_recent_conversation_user(self.request.user)
        context['active_user'] = last_conversation.username
        return context
